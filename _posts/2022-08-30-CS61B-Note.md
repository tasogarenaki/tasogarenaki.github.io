...
- Merge Sort: $\Theta(N\text{log}N)$
  ...
  - Merging two sorted lists into one sorted list has a time complexity of $O(N)$. Therefore, by repeatedly performing the merge operation $\text{log}N$ times, we can achieve the merge sort.

  <img src="https://github.com/tasogarenaki/tasogarenaki.github.io/blob/main/pics/cs61b/mergesort.jpeg?raw=true" alt="mergesort" style="zoom:100%;" />
