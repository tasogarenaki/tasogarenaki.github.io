...
- **Interface Inheritance:** is a specification of what a List is able to do (methods and parameters), not how to do. THe subclass must have all methods of the interface. 
